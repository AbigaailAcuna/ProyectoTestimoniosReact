import './App.css';
//debo importar los componentes en arcchivos externos, pero debe ser bidireccional, lo exporto desde esttimonio y lo importo desde app,js
  ...
  return (
    <div className="App">
      <div className='contenedor-principal'>
        {/*acá está lo que se muestra en nuestra aplicación web principal, para llamar la parte que estoy trabajando ahorita de testimonios, lo hago desde acá*/}
